  ...
  imageContainer.addEventListener('click', function (event) {
    ...
    image.innerHTML = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 288 288">
        <circle cx="144" cy="144" r="144" fill="${randomColor}" stroke-width="0"/>
      </svg>
    `;
